  ...
  return (
    <section className={styles.manifest_container}>
      ...
      <div className={styles.manifest_more_info}>
        <p>
          En voidXR canalizamos la creatividad en experiencias inmersivas únicas
          para marcas, museos y centros educativos.
        </p>
        <p>
          Nuestra especialización técnica garantiza soluciones sólidas y
          confiables, diseñadas para maximizar el retorno de inversión para
          nuestros clientes.
        </p>
        <p>
