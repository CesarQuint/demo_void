...
const GalleryCarousel: React.FC<GalleryProps> = ({ data }) => {
    ...
    const setActiveIdxFromDragX = () =>
        void dragX.get() === 0 &&
        setActiveImageIdx((pv) => (pv === IMAGES.length - 1 ? 0 : pv + 1));

    useEffect(() => {
        const interval = setInterval(setActiveIdxFromDragX, AUTO_DELAY);
        ...
        !!IMAGES.length && (
            <section id="gallery">
                ...
                <div className={styles.container}>
                    ...
                    >
                        <Images images={IMAGES} activeIdx={activeImageIdx} />
                    </motion.div>
