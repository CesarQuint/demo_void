    ...
    return (
        <div ref={containerRef}>
            ...
            <p ref={textRef} className={`${styles.text} ${styles.test}`}>
                ...
                efficitur massa sit amet, sodales lacus. Ut dapibus quam
                gravida, laoreet ex nec, tincidunt orci. Nam rutrum velit ante,
                nec consequat erat finibus vitae. Nulla pretium malesuada dolor
                ac pretium.
            </p>
