var ogl = (function (t) {
    ...
    class g {
        ...
        computeBoundingBox(t) {
            !t &&
                ...
                (t = this.attributes.position.data),
    ...
    class Y extends C {
        ...
        draw({ camera: t } = {}) {
            this.onBeforeRender &&
                this.onBeforeRender({ mesh: this, camera: t }),
                t &&
    ...
    class H extends Array {
        ...
        static hexToRGB(t) {
            ...
            return (
                e ||
                    console.warn(
                        `Unable to convert hex string ${t} to rgb values`,
                    ),
                [
                    parseInt(e[1], 16) / 255,
                    parseInt(e[2], 16) / 255,
    ...
    return (
        ...
        (t.Camera = class extends C {
            ...
            frustumIntersectsMesh(t) {
                ...
                const i =
                    ...
                    t.worldMatrix.getMaxScaleOnAxis();
            ...
            constructor(
                ...
                (this.passes = []),
                    ...
                    (this.size = Math.pow(
                        2,
                        Math.ceil(
                            Math.log(Math.ceil(Math.sqrt(this.dataLength))) /
                                Math.LN2,
                        ),
                    )),
        ...
        (t.Orbit = function (
            ...
            E.copy(t.position).sub(this.target),
                ...
                (v.phi = M.phi =
                    Math.acos(Math.min(Math.max(E.y / M.radius, -1), 1))),
                (this.update = () => {
                    (M.radius *= b.radius),
                        (M.theta += b.theta),
                        (M.phi += b.phi),
            ...
            createBoneTexture() {
                ...
                const t = Math.max(
                    ...
                    Math.pow(
                        2,
                        Math.ceil(
                            Math.log(Math.sqrt(4 * this.bones.length)) /
                                Math.LN2,
                        ),
                    ),
                );
