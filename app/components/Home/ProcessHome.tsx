    ...
    return (
        <motion.section className={styles.main}>
            ...
            <motion.div className={styles.description}>
                <p>
                    Somos un grupo de artistas digitales apasionados por la
                    tecnología y la comunicación, expertos en crear experiencias
                    para solucionar los retos que enfrentan nuestros clientes y
                    comunicar nuestras propias ideas.
                </p>
            </motion.div>
        </motion.section>
    );
